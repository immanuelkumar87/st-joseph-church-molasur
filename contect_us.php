...
<section class="py-5" id="contact">
      <div class="container py-5">
        ...
        <div class="row align-items-stretch gx-0">
          <div class="col-lg-6">      
            <div class="contact-img bg-center bg-cover" style="background: url(http://localhost/StJoseph/wp-content/themes/twentyseventeen/assets/img/joseph/tmpUe3m9N.jpeg)"></div>
          </div>
          <div class="col-lg-6">
            <div class="bg-light p-5 h-100">
              ...
              <ul class="list-unstyled mb-0 text-muted">
                <li class="mb-2"><a class="reset-anchor" href="tel:+0035478968"> <i class="text-primaryn me-3 fas fa-phone"></i><span>+003 5478 968</span></a></li>
                <li class="mb-2"><a class="reset-anchor" href="text.html"> <i class="text-primaryn me-3 fas fa-globe-americas"></i><span>The Parish Priest, &nbsp;St.Joseph's Church,&nbsp;Molasur, &nbsp;S.V.Chatram(Post)&nbsp; 602106,</span></a></li>
