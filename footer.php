...
<footer class="pt-5 text-white" style="background: #e3d28c">
      <div class="container pt-5">
        <div class="row mb-5 pb-5">
          ...
          <div class="col-md-4 col-sm-12">
            ...
            <ul class="list-unstyled">
              <li class="mb-2">
                <p class="mb-1 "> <a href="#">About St Joseph</a></p>
               <p class="mb-1"> <a href="#">Religious Institutions</a></p>
               <p class=" mb-1"> <a href="#">Gallery</a></p>
               <p class="mb-1"> <a href="#">Downloads</a></p>
